...
function BottomNav({ activeTab, onTabChange }) {
  ...
  const tabs = [
    { id: "players", label: "Players", color: COLORS.yellow, hoverColor: "#FFD93D40", icon: (color) => (
    ...
    { id: "modules", label: "Modules", color: "#B388FF", hoverColor: "#B388FF40", icon: (color) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    { id: "parentZone", label: "Parent Zone", color: "#06D6A0", hoverColor: "#06D6A040", icon: (color) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div style={{
      ...
      <div style={{
        ...
        {tabs.map((tab) => {
          ...
          const iconColor = isActive ? COLORS.black : (isHovered ? COLORS.black : "#999");
          return (
            <button
              key={tab.id}
              ...
              style={{
                ...
                background: isActive ? tab.color : (isHovered ? tab.hoverColor : "transparent"),
                border: "none",
                cursor: "pointer",
                display: "flex",
            ...
            >
              ...
              <span style={{
                ...
                fontFamily: "'Space Grotesk', sans-serif",
                color: isActive ? COLORS.black : (isHovered ? COLORS.black : "#999"),
  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: 600, margin: "0 auto" }}>
        ...
        {/* Legal links moved to Parent Zone Settings */}
      </div>
