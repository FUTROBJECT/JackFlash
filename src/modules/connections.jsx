...
const T1_ITEMS = [
  ...
  { id: "t1:7baskets4eggs2boxes", text: ["7 baskets. Each basket has 4 eggs.", "All the eggs go into 2 boxes equally.", "How many eggs in each box?"], step1: { op: "×", a: 7, b: 4, result: 28, label: "7 × 4" }, step2: { op: "÷", a: 28, b: 2, result: 14, label: "28 ÷ 2" }, answer: 14 },
  { id: "t1:5pages6words2groups", text: ["5 pages of words. Each page has 6 words.", "The words are split into 2 equal groups.", "How many words in each group?"], step1: { op: "×", a: 5, b: 6, result: 30, label: "5 × 6" }, step2: { op: "÷", a: 30, b: 2, result: 15, label: "30 ÷ 2" }, answer: 15 },
  { id: "t1:2shelves10books4piles", text: ["2 shelves of books. Each shelf has 10 books.", "The books are stacked into 4 equal piles.", "How many books in each pile?"], step1: { op: "×", a: 2, b: 10, result: 20, label: "2 × 10" }, step2: { op: "÷", a: 20, b: 4, result: 5, label: "20 ÷ 4" }, answer: 5 },
  { id: "t1:6packs4stickers3kids", text: ["6 packs of stickers. Each pack has 4 stickers.", "3 children share all the stickers equally.", "How many stickers each?"], step1: { op: "×", a: 6, b: 4, result: 24, label: "6 × 4" }, step2: { op: "÷", a: 24, b: 3, result: 8, label: "24 ÷ 3" }, answer: 8 },
  // (× then ×)
...
const T2_ITEMS = [
  ...
  { id: "t2:4packs5stickerThird", text: ["4 packs with 5 stickers in each.", "One quarter of the stickers are shiny.", "How many stickers are shiny?"], step1: { op: "×", a: 4, b: 5, result: 20, label: "4 × 5" }, step2: { op: "frac", n: 1, d: 4, quantity: 20, result: 5, label: "1/4 of 20" }, answer: 5 },
