...
import {
  gcd, simplify, FractionDisplay, FractionBar, TwoStackedBars,
} from "../shared/barComponents.jsx";

// FractionDisplay, FractionBar and TwoStackedBars (and gcd/simplify) have
// one copy, in src/shared/barComponents.jsx; this module used to carry its
// own byte-equivalent set. Re-exported so fractions-practice.jsx keeps
// importing its visual components from here.
export { FractionDisplay, FractionBar, TwoStackedBars };
